...
awk 'BEGIN {OFS="\t"} {print $1, $2, $3, $5, $6, $4, "-"}' NONCODEv6_hg38.lncRNAGene.bed > NONCODEv6_hg38.lncRNAGene_temp.bed
awk 'BEGIN {OFS="\t"} {print $1, $2, $3, $5, $6, "-", $4}' lncRNA_gene_LncBookv2.0_GRCh38.bed > lncRNA_gene_LncBookv2.0_GRCh38_temp.bed
