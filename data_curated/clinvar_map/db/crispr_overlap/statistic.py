...
df = df[['ChromosomeName', 'GenomicStartLoc', 'GenomicEndLoc', 'GenomicStrand', 'NoncodeID', 'LncBookID', 
		 'chromStart','chromEnd', 'Type', 'ClinicalSignificance', 
		 'VariationID', 'ReferenceAlleleVCF', 'AlternateAlleleVCF', 'CompletePhenotypeList']]
